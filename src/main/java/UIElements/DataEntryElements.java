...
//Data Level
    ...
    public static By PradeshDatalevel = By.xpath("//h5[contains(text(),'Pradesh')]" +
            "//parent::div//parent::div//parent::div[@class='col-md-3']" +
            "//following-sibling::div[@class='col-md-9']//button//span[@class='mat-button-wrapper']");
    public static By LoksabhaLevel = By.xpath("//h5[contains(text(),'Lok Sabha')]" +
            "//parent::div//parent::div//parent::div[@class='col-md-3']" +
            "//following-sibling::div[@class='col-md-9']//button//span[@class='mat-button-wrapper']");
    public static By VidhanSabhaLevel = By.xpath("//h5[contains(text(),'Vidhan Sabha')]" +
            "//parent::div//parent::div//parent::div[@class='col-md-3']" +
            "//following-sibling::div[@class='col-md-9']//button//span[@class='mat-button-wrapper']");
    public static By ZilaLevel = By.xpath("//h5[contains(text(),'Zila')]" +
            "//parent::div//parent::div//parent::div[@class='col-md-3']" +
            "//following-sibling::div[@class='col-md-9']//button//span[@class='mat-button-wrapper']");
    public static By MandalLevel = By.xpath("//h5[contains(text(),'Mandal')]" +
            "//parent::div//parent::div//parent::div[@class='col-md-3']" +
            "//following-sibling::div[@class='col-md-9']//button//span[@class='mat-button-wrapper']");
    public static By ShaktiKendraLevel = By.xpath("//h5[contains(text(),'Shakti Kendra')]" +
            "//parent::div//parent::div//parent::div[@class='col-md-3']" +
            "//following-sibling::div[@class='col-md-9']//button//span[@class='mat-button-wrapper']");
    public static By BoothLevel = By.xpath("//h5[contains(text(),'Booth')]" +
            "//parent::div//parent::div//parent::div[@class='col-md-3']" +
            "//following-sibling::div[@class='col-md-9']//button//span[@class='mat-button-wrapper']");
    //	Static xpath
    public static By ProfilIcon =By.xpath("//*[name()='path' and contains(@d,'M0 15C0 6.')]");
    public static By AbhiyanCard = By.xpath("//mat-card-title[text()=' Abhiyan Data Entry ' ]");

...
@CucumberOptions(features = "src/src/test/sangathan_features/wardKaryakarta/wardKaryakarta.feature", glue = {"sangathan_stepdefinations", "hooks" }, publish = true, plugin = { "pretty",
